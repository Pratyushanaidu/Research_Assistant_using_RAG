...
A Flask-based web application is now available as an alternative to the CLI.
...
2.  **Using the Web Interface:**
    ...
    *   The interface shows the index status.
    *   If the index is ready, enter your query in the text field and click "Search".
    *   View the results, including suggested PDFs and LLM recommendations.
